...
const AdvertiseCart = ({category}) => {
    ...
    const {  name,picture, verified, originalPrice,sellerName ,resalePrice,usedYear,postedTime } = category;
    return (
      ...
      <div className="card-body">
        <h2 className="card-title">
          {name}
          {
            verified!=='false'?
            <>
            <div className="badge badge-secondary"><GoVerified className="text-white" />
                </div>
            </>:<></>
