...
const Service = () => {
  const shopData = [
    ...
    },
    {
      ...
      description:
        "Our Expertise can do any kind. Within 3 working day we will return your device. ",
      icons: <FaMobileAlt />,
      bgClass: "bg-accent",
    },
    {
      ...
      name: "Contact Us",
      description:
        "Our shop time -> Open 9.00 am to 5.00 pm everyday. Contact us before you come. +8801345678910",
      icons: <FaPhoneVolume />,
      bgClass: "bg-gradient-to-r from-primary to-secondary",
    },
  ];
  return (
    <div className="mt-16">
      ...
      <div className="grid gap-6 mt-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {shopData.map((shop) => (
          <Services key={shop.id} shop={shop}></Services>
        ))}
      </div>
    </div>
  );
