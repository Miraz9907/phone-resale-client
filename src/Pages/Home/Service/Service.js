...
const Service = () => {
    ...
    const shopData = [
        ...
        },
        {
            ...
            description: 'Our Expertise can do any. Within 3 working day we will return your device. ',
        ...
        },
        {
            id: 3,
            name: 'Contact Us',
            description: 'Our shop time -> Open 9.00 am to 5.00 pm everyday. Contact us before you come',
